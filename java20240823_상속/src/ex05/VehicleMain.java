...
public class VehicleMain {
	...
	public static void main(String[] args) {
		...
		Vehicle c1 = new Car("123가 4567", "홍길동", "Gasoline", 5);
		c1.info();
		
		System.out.println();
		
		Vehicle t1 = new Truck("789나 1011", "이순신", 10.0 );
		t1.info();
...
abstract double calculateMaintenanceCost() (정비 비용을 계산하는 메서드): 각 차량의 정비 비용을 계산하여 반환하는 메서드입니다.
